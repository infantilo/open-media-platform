...
// Nachrichten werden als sse.Event an hub weitergereicht. Ein initial
// nicht erreichbares NATS ist nicht fatal (RetryOnFailedConnect): der
// Orchestrator läuft weiter und verbindet sich, sobald NATS erreichbar
// ist — konsistent mit der Resilienz-Linie aus internal/registry.Poller.
func Connect(url string, hub *sse.Hub) (*nats.Conn, error) {
