...
| Zeitbasis-Bug (PRIO HOCH): Medienzeit = Grain-Index auf TAI, 8 Ursachen gefixt (Nachtrag 271) — ZWISCHENSTAND | teilweise | Nutzerauftrag "fix timebase bug". Harness reproduziert Standbilder/Rücksprünge/"Roboterstimme" ohne Handy; Fix in `omp-mediaio` (`timebase.rs`, Leser-PTS aus Index, Schreib-Index aus PTS, Stale-Slot-Prüfung, Puffergrößen, Origin-Cap, Audio-Cap) + omp-switcher Swap-Timeout-Freeze. Harness: phone 0 Standbilder statt 42-47, Audio sauber. `cargo test --workspace` 263/263. OFFEN: Live-Test WebRTC-Pfad + Bestätigung am echten Handy; `OMP_MXL_TIMEBASE=arrival` als Rückweg. | 2026-09-23 |
