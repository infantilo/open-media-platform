...
| ARCHITECTURE.md: "Matrox Origin"-Erwähnungen entfernt (Nutzerauftrag) | erledigt | §1/§9/§10 hatten trotz des 2026-07-11-Vendor-Neutralitäts-Passes noch vier "Matrox Origin"/"Matrox ORIGIN"-Nennungen (Vision-Beispiel, MXL-Kompatibilitäts-Werbeaussage, Austauschbarkeits-/Drift-Risiko-Beispiele) — entfernt, Kernaussagen ohne Produktnamen erhalten. Übrige generische "Matrox"-Nennungen (Tiger-Team-Mitgliedschaft, ConvertIP/DSX/Avio2-Interop, Presse-Quelle) bewusst unangetastet, gleiche engere Auslegung wie beim 2026-07-11-Pass. Historische Zitate in `docs/decisions.md` bleiben Append-Only unverändert. Details docs/decisions.md Nachtrag 138. | 2026-08-10 |
